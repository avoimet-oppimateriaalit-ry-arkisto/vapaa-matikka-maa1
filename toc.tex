...
% Jos haluat kääntää vain yhden luvun, käytä komentoa
% ./kaanna_luku.sh <luvun nimi>
% esimerkiksi
% ./kaanna_luku.sh yhtalo

\osa{Luvut ja laskutoimitukset}
    \luku{luku_ja_relaatio}{Luku ja relaatio}
    \luku{lukualueet}{Johdatus lukualueisiin}
    ...
    \luku{yksikot}{Yksiköt ja suuruusluokat}
