...
Huom.: $0,42x$ voidaan tulkita myös niin, että perusarvo on $0,42$ ja $x$ on prosenttikerroin (muotoa $1\pm \frac{p}{100})$.
	\end{vastaus}
\end{tehtava}
...
\hline
Kommunistinen Työväenpuolue -- Rauhan ja Sosialismin puolesta & $1\,065$ & $704$ \\
\hline
Köyhien Asialla & $1\,059$ & $572$ \\ 
\hline
Suomen Kommunistinen Puolue & $13\,986$ & $11\,174$ \\ 
\hline 
Suomen Työväenpuolue STP & $703$ & $538$ \\ 
\hline 
\end{tabular}
\alakohdat{
§ Minkä puolueen kannatus laski eniten äänissä laskettuna?
§ Minkä puolueen äänisaalis laski eniten prosentuaalisesti?
}
	\begin{vastaus}
	\alakohdat{
...
\begin{tehtava} %lähde: Vaalit.fi
    ...
    \alakohdat{
    § Kuinka monta prosenttiyksikköä kannatus nousi? (Tiedotusvälineissä kannatusmuutokset ilmoitetaan yleensä prosenttiyksiköissä.)
    § Kuinka monta prosenttia kannatus nousi?
    }
    \begin{vastaus}
        \alakohdat{
...
\begin{tehtava}
Eräällä kuvitteellisella saarella on kaksi valtiota: X ja Y. Valtioissa oli saman verran asukkaita, kunnes niiden välille syttyi sota. Tuhoisan ja hyvin yksipuolisen sodan seurauksena valtion Y asukasmäärä putosi sadasosaan entisestä, ja valtion X asukasmäärä putosi viisiprosnettia.
\alakohdat{
...
\begin{tehtava}
    Matin ja Iidan duo saa julkisuutta, ja he alkavat myydä CD-levyään keikkojen yhteydessä $10$ euron kappalehinnalla. Jonkin ajan päästä he päättävät nostaa CD-levyn hintaa $20$ prosenttia. Matti alkaa kuitenkin katua päätöstä, ja ehdottaa tämän korotetun hinnan alentamista $20$ prosentilla.
    \alakohdat{
