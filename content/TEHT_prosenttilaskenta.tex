...
\begin{tehtava}
	...
	\begin{alakohdat}
		\alakohta{Kuinka monta prosenttia kalliimpaa on varata joukolle yksityispeli kuin liput avoimeen peliin?}
		\alakohta{Kuinka suuri seurueen on vähintään oltava, jotta yksityispeli tulisi halvemmaksi?}
	\end{alakohdat}
	\begin{vastaus}
		\begin{alakohdat}
			\alakohta{$381\,\%$}
...
\begin{tehtava}
    ...
    \end{vastaus} %piraattipuolueversio ;) 0,5 % -> 0,7 % 
\end{tehtava}
