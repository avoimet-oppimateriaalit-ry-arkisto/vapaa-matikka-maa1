...
\begin{tehtava} Supista 
	\begin{alakohdatrivi}
		...
		\alakohta{$\frac{27}{30}$}
		\alakohta{$\frac{2}{32}$}
		\alakohta{$\frac{65}{105}$}
		\alakohta{$\frac{144}{243}$.}
	\end{alakohdatrivi}
\begin{vastaus}
	\begin{alakohdat}
		\alakohta{$\frac{3}{4}$}
...
\begin{tehtava} Laske
	\begin{alakohdat}
		\alakohta{$\frac{2}{3} : \frac{7}{11}$}
		\alakohta{$\frac{4}{3}:\left(\frac{-13}{4}\right)$}
		\alakohta{$\frac{7}{8}:4$}
		\alakohta{$\frac{1}{\frac{3}{7}-\frac{9}{21}}$.}
	\end{alakohdat}
\begin{vastaus}
	\begin{alakohdat}
		\alakohta{$1\frac{1}{21}$}
		\alakohta{$-\frac{16}{39}$}
		\alakohta{$\frac{7}{32}$}
		\alakohta{ei määritelty (nollalla jakaminen)}
	\end{alakohdat}
\end{vastaus}
\end{tehtava}
...
\begin{alakohdat}
\alakohta{$x$ ja $\frac{3}{8}$ tulo on $0$?}
\alakohta{$x$ ja $\frac{3}{8}$ tulo on $1$?}
...
Sievennä
 \begin{alakohdat}
  ...
  \alakohta{$\frac{208ab+52b+26b({\frac{a}{26}}-{\frac{6a}{3a}})-ab}{-42ab+52b+42ba}$.}
 \end{alakohdat}
 \begin{vastaus}
	\begin{alakohdat}
		\alakohta{$a+1$}
