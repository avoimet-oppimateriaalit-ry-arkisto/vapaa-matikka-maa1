...
%leipomisverrannollisuus	
	...
	\begin{tehtava} %is dum :(
	\alakohdat{
	§ Laske $f(2)$, kun $f(x)=5x^3-12x^{-2}-2$.
	§ Tutki kuvaajasta, mitkä ovat funktion $f(x)=2x^2-3x-2$ nollakohdat ja lisäksi arvo, kun $x=1$. Millä muuttujan arvoilla $f$ saa arvon $3$? Laske $f(7)$. 
	 }
	\begin{vastaus}
	 \alakohdat{
	  § $x = 35$
