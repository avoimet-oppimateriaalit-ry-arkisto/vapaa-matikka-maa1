...
§ Viidesosa mölleistä on pällejä, ja kuudesosa pälleistä on tirboja. Jos pälleistä puolet on jukebokseja, joita on kolme, niin kuinka monta mölliä on enemmän kuin tirboja?
}
	\begin{vastaus}
	\alakohdat{
§ $a=0$
