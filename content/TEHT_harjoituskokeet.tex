...
Sievennä
	 \begin{alakohdat}
	 \alakohta{$a^{\frac{1}{3}} + a^{\frac{1}{4}} + a^{\frac{1}{5}} + a^{\frac{13}{60}}$}
...
Laske käyttämällä potenssien laskusääntöjä
	...
	\end{tehtava}
	\begin{tehtava}
Timanttien arvo on karkeasti suoraan verrannollinen niiden massan neliöön. Kuulu timantti The Great Mogul painaa noin 800 karaattia. The Sancy --timantti painaa noin 50 karaattia. Kuinka paljon
	\begin{alakohdat}
	...
	\end{tehtava}
	\begin{tehtava}
	 Laboratoriossa viljellään erästä bakteeria, joka kolminkertaistuu päivässä. 5 päivän kasvatuksen jälkeen bakteereja on 243 grammaa. Kuinka paljon bakteereja
	 \begin{alakohdat}
