...
\begin{tehtava}
	...
	\begin{vastaus}
	 \alakohdat{
	  § $x = 35$
	  § Nollakohdat ovat $x=-0,5$ ja $x = 2$. Funktio saa arvon $3$, kun $x = -1$ tai $x = 2,5$. Funktion pienin arvo on kuvaajan perusteella noin $-3,125$.
	 }
	\end{vastaus}
		\begin{center}
...
\begin{tehtava}
\alakohdat{
§ Ratkaise $a$ yhtälöstä $x-a^{9\,001}=a^{9\,001}+x$.
§ Suorakulmaisen kolmion hypotenuusan pituus on $4$ pituusyksikköä ja kateetit ovat yhtä pitkät. Kuinka pitkiä kateetit ovat?
§ Ratkaise $t$ yhtälöstä $\frac{t}{t-1}=\frac{2t-1}{t-1}$.
}
	\begin{vastaus}
	\alakohdat{
§ $a=0$
§ Kummankin kateetin pituus on $\sqrt{8}$ pituusyksikköä. (ratkaistaan yhtälö $x^2+x^2=4^2$, missä $x$ on kateetin pituus)
...
\end{tehtava}	
	...
	\begin{tehtava}
	\alakohdat{
§ Sukkien hintaa alennettiin $50$\,\%. Kuinka monta prosenttia hintaa täytyy nostaa, jotta saavutetaan alkuperäinen hinta? § Valtion väestö on kasvanut $10$ vuodessa $10$\,\%. Kuinka monta prosenttia väestö on kasvanut keskimäärin vuodessa? Anna vastaus prosentin sadasosien tarkkuudella.
}
	\begin{vastaus}
	\alakohdat{
	§ $100$\,\%.
