...
Jos kahdella murtoluvulla on sama nimittäjä, niitä sanotaan \termi{samannimiset}{samannimisiksi}. %yhdyssana...? JA TARKISTA MURTOLUKU, RATIONAALUKU, MURTOLUKUMUOTO, MURTOLUKUESITYS -KOHERENSSI!!!
...
\begin{esimerkki}
    ...
    %    Aloitetaan muuttamalla sekalukuesitys murtoluvuksi.
        \begin{align*}
            ...
            &=\frac{45:3}{21:3}\\
            &=\frac{15}{7}\\
            &=\frac{2\cdot7+1}{7}\\ %TÄSTÄ ETEENPÄIN, TÄMÄ VAIHE PITÄÄ SELITTÄÄ (eli lavennus ``käänteisesti``)
