...
Jos kahdella murtoluvulla on sama nimittäjä, niitä sanotaan \termi{samannimisyys}{samannimisiksi}. %yhdyssana...? JA TARKISTA MURTOLUKU, RATIONAALUKU, MURTOLUKUMUOTO, MURTOLUKUESITYS -KOHERENSSI!!!
...
\laatikko{
    ...
    voidaan murtoluvut laskea yhteen laskemalla osoittajat yhteen. %PERUSTELU: PERUSTUU OSITTELULAKIIN
    \[
...
\begin{esimerkki}
        ...
        \textbf{Ratkaisu.}
    %    Aloitetaan muuttamalla sekalukuesitys murtoluvuksi.
        \begin{align*}
            ...
            &=\frac{15}{7}\\
            &=\frac{14+1}{7}\\
            &=\frac{2\cdot7+1}{7}\\ %TÄSTÄ ETEENPÄIN, TÄMÄ VAIHE PITÄÄ SELITTÄÄ (eli lavennus ``käänteisesti``) (osittelulaki)
