...
% 	\[ \text{laventaminen}\]
% 	\[ \longrightarrow\]
% Nuoliviritys toimisi, mutta rivivälit kaipaavat muokkausta (laventaminen ja nuoli lähemmäs toisiaan). 
	 \[
	 \frac{a}{b} = 1\cdot \frac{a}{b} = \frac{c}{c} \cdot \frac{a}{b} = \frac{ca}{cb}
	 \]
	 missä $b \neq 0$ ja $c \neq 0$.
}
