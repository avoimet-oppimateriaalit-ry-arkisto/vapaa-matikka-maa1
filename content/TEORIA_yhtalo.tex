...
\begin{esimerkki}
	\begin{alakohdat}
		\alakohta{$x+3=\frac{5}{7}+2$ on yhtälö, joka väittää lausekkeiden $x+3$ ja $\frac{5}{7}+2$ olevan lukuarvoltaan yhtä suuret.}
		\alakohta{$2=\frac{4}{2}$ on yhtälö, joka väittää, että luku $2$ voidaan esittää myös muodossa $\frac{4}{2}$.}
	\end{alakohdat}
\end{esimerkki}
...
\begin{esimerkki}
	\begin{alakohdat}
		...
		\alakohta{Yhtälö $t=t$ on tosi kaikilla muuttujan $t$ lukuarvoilla, sillä jokainen luku on varmasti yhtä suuri itsensä kanssa.}
		\alakohta{Yhtälö $x=x+1$ on epätosi kaikilla $x$:n arvoilla, koska mikään luku ei voi olla yhtä suuri kuin sitä yhtä suurempi luku.}
		\alakohta{Yhtälö $x+2=0$ pätee vain siinä tapauksessa, että $x=-2$.}
	\end{alakohdat}
\end{esimerkki}

%yhtä suuri... yhtä suuri :D


%Virkerakenne ja yhtälöiden luokittelulaatikon otsikointi...
...
\laatikko[Yhtälöihin liittyviä käsitteitä]{
	\begin{description}
		\item[Tuntematon] Luku, jonka arvoa ei tiedetä. Tuntemattomia merkitään vaihtelevilla symboleilla. Jos tuntemattomia on vain yksi, sitä merkitään 	yleensä kirjaimella $x$. Tuntemattomien lisäksi yhtälöissä voi olla \termi{vakiotermi}{vakiotermejä}, joiden arvo ei riipu muuttujan $x$ arvosta.
...
Koska yhtälön molemmat puolet ovat yhtä suuret eli tarkoittavat täsmälleen samaa asiaa, niin jonkin molempiin puoliin kohdistetun laskutoimituksen jälkeen ne ovat edelleen yhtä suuret.
}

%selitetään, mitä on puolittain kertominen jne., puolittain......
...
\laatikko[Yhtäsuuruusrelaation ominaisuuksia]{
...
\item \termi{transitiivisuus}{Transitivisuus}: Jos $x=y$ ja $y=z$, niin $x=z$.
...
% mihinkäs tämä alempi teksti, kun yhtälön ratkaisua/muokkaamista on jo käyty aiemmin...
...
%TEHTÄVIÄ tähän ennen ensimmäisen asteen yhtälöä!

%TEHTÄVIÄ: 1) Onko yhtälö tosi vai epätosi? Aina tosi, ehdollsiesti tosi? 2) Tarkista, voivatko seuraavat olla yhtälön juuria, ... 3) Kirjoita yhtälönä?

%Tutki, onko X yhtälön juuri...