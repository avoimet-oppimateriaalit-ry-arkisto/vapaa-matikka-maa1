...
a) Tarmo syö 3 palaa neljästä eli $\frac{3}{4} = 0,75$. Tämä voidaan muuttaa prosenttiluvuksi lukemalla, kuinka monta sadasosaa luvussa on. Näiden lukumäärän saamme kertomalla sadalla: $0,75 \cdot 100 = 75\%$. Tarmo pisti poskeensa $75\%$ pizzasta
...
\laatikko{
    ...
    Suhteellinen muutos saadaan suhteuttamalla absoluuttinen muutos alkuperäiseen lukuun $a$ eli laskemalla
...
\laatikko{
    ...
    Jos luku $a$ on $p~\%$ pienempi/suurempi kuin luku $b$, pätee
    \[ p = \frac{|b-a|}{b} \].
}
...
% VERTAILUPROSENTTI
\laatikko{
    \termi{Vertailuprosentilla}{Vertailuprosentilla} tarkoitetaan sitä, kuinka paljon jokin on jostakin.
...
% MUUTOSKERTOIMESTA PIENI TEORIA PLÄJÄYS?
\begin{esimerkki}
...
% PROSENTTIYKSIKKÖ
\laatikko{
    \termi{prosenttiyksikkö}{Prosenttiyksikköä} käytetään mittaamaan prosenttien absoluuttista muutosta.
    ...
    prosentteina(prosenttimuutos) tai prosenttiyksikköinä(absoluuttinen muutos).
