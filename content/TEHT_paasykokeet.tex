...
\begin{description}
    ...
    \alakohdat{
        § Kuinka monta litraa vettä taloyhtiössä valuu hukkaan minuutissa?
        § Vuodot tukitaan. Montako prosenttia vesimaksua voitaisiin laskea tai tulee korottaa, jotta vesimaksu tällöin kattaisi taloyhtiön vuotuiset vesikulut?
    }
...
\begin{description}
    ...
    \alakohdat{
        § Paljonko kultaukseen käytetyn kullan määrä kasvoi toteutuksen aikana?
        § Teräksen yksikköhinta ei toteutuksen aikana muuttunut. Miten kullan yksikköhinta siis muuttui?
    }
...
\begin{description}
	\item[(2012/3)] Asumistukea maksetaan 80\,\% vuokran määrästä, siltä osin kuin
		...
		\alakohdat{
			§ Minkä suuruinen vuokra on, kun omavastuu on puolet vuokrasta?
		}
	...
	\item[(2009/1)] Kokonaistuotanto jaetaan materian ja palveluiden tuotantoon.
	   ...
	   Kuinka suuri oli materiatuotannon osuus kokonaistuotannosta tammikuussa 2009,
    	...
    	\alakohdat{
    		§ kun tammikuussa 2008 materia- ja palvelutuotanto olivat yhtäsuuret?
    		§ kun vertailuaikana kokonaistuotanto laski 2,0\,\%?
    	}
    	
	   Anna kummatkin vastaukset 0,1\,\%-yksikön tarkkuuteen pyöristettynä.

	\item[(2008/2)] Yritys hankkii $5\,000$\,kg raaka-ainetta, josta on vettä $5,40$\,\%
    	...
    	\alakohdat{
    		§ Miten paljon hankittuun raaka-aineeseen tulee lisätä vettä, jotta haluttu vesipitoisuus saavutetaan?
    		§ Miten paljon vettä ja väripigmenttiä tulee lisätä hankittuun raaka-aineeseen, jotta haluttu vesipitoisuus saavutetaan, ja lisäksi väripigmentin suhteellinen osuus massasta säilyy alkuperäisenä $2,60$\,\%:na?
    	}
	...
	\item[(2007/1)] Vaaleissa kaikkiaan 39\,300 äänestäjästä 45\,\% äänestää varmasti
    	...
    	\alakohdat{
    		§ Oletetaan, että kaikki äänioikeutetut äänestävät. Kuinka monta liikkuvien äänestäjien ääntä puolueen A täytyy tällöin kerätä saadakseen enemmistön, vähintään puolet annetuista äänistä?
    		§ Oletetaan, että täsmälleen kolmasosa liikkuvista äänestäjistä jättää äänestämättä. Kuinka monta prosenttia liikkuvien äänestäjien annetuista äänistä puolueen A täytyy tällöin kerätä saadakseen enemmistön kaikista annetuista äänistä?
    	}	 	
...
\begin{description}
	\item[(K2012/3)] Erään tuotteen valmistuskustannuksista raaka-aineiden osuus on
    	...
    	\alakohdat{
    		§ Jos työntekijät saavat 5\,\% palkankorotuksen, niin kuinka monta prosenttia tuotteen valmistuskustannukset kasvavat?
    		§ Jos toisaalta valmistuskustannukset halutaan pitää ennallaan palkankorotuksen jälkeen, niin montako prosenttia raaka-ainekustannusten pitää pienentyä?
    	}	 
	...
	\item[(S2011/2)] Olkoon $a=132$ ja  $b=112$. Kuinka monta prosenttia 
		\alakohdat{
			§ luku a on suurempi kuin luku b
			§ luku b on pienempi kuin luku a
			§ luku b on luvusta a? 
		}
