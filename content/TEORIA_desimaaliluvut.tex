...
$\frac{1}{7}=0,\overline{142857}$ jakso on pisin mahdollinen, $7-1=6$ numeron mittainen.
...
\end{alakohdat}
Huomaa, että tavan mukaan jakolaskun mennessä tasan desimaaliluvun tulevia nollia $\ldots000\ldots=\overline{0}$ ei merkitä, kuten ei nollia luvun edessäkään.
	\begin{alakohdat}
	\alakohta{$\frac{5}{4} = 1,250000\ldots = 1,25\overline{0}$ merkitään $1,25$}
	\alakohta{$001,25$ merkitään $1,25$}
	\end{alakohdat}
\end{esimerkki}
