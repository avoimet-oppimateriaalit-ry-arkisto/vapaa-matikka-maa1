...
Mikäli potensseja on monta päällekkäin (eli eksponenttina on potenssilauseke), laskeminen aloitetaan ylimmästä potenssista. Esimerkiksi
\[2^{3^2}= 2^9 = 512, \]
mutta
\[(2^3)^2=8^2=64. \]

   
%    \numerointilaatikko{Laskujärjestys}{
%            § Sulut
%            § Potenssilaskut
...
Jos kantaluku on negatiivinen, sen ympärille merkitään selkeyden vuoksi aina sulkeet. Esimerkiksi
...
\begin{esimerkki}
Monesti tulee tarpeeseen sieventää lausekkeiden potensseja kuten $(x+2)^2$. Tämä tapahtuu potenssin määritelmällä ja osittelulailla:
	\begin{align*}
	(x+2)^2
...
Tällaista merkintätavan, jolla alunperin oli intuitiivinen merkitys, yleistämistä mahdollisimman laajakäyttöiseksi kutsutaan \termi{analyyttinen jatkaminen}{analyyttiseksi jatkamiseksi}. ... Potenssimerkintää laajennetaan vieläkin yleisemmäksi luvussa Murtopotenssi. %VIITE