	...
	\begin{description}
		\item[Laskutoimitukset], joita ovat
			...
			\begin{itemize}
				...
				\item{Puolittain kertominen tai jakaminen: yhtälön molemmat puolet voidaan kertoa tai jakaa nollasta poikkeavalla luvulla tai muuttujalla. Muuttujalla jakaessa täytyy ottaa huomioon ja merkitä, että yhtälö ei ole määritelty, kun muuttuja on nolla.
