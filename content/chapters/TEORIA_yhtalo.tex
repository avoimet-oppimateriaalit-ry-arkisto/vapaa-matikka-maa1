...
\laatikko[Yhtälöiden muokkaaminen]{
	\begin{description}
		\item[Laskutoimitukset], joita ovat
			...
			\begin{itemize}
				\item{Puolittain lisääminen ja vähentäminen: yhtälön molemmille puolille voidaan lisätä tai molemmilta puolilta voidaan vähentää luku. 
				Esimerkiksi yhtälö $3x+5 = 3$ saadaan näin muotoon $3x = -2$.}
				\item{Puolittain kertominen tai jakaminen: yhtälön molemmat puolet voidaan kertoa tai jakaa nollasta poikkeavalla luvulla. 
