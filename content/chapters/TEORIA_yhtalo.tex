...
\begin{esimerkki}
	Juna Helsingistä Jyväskylään kulkee $342$ kilometrin matkan kolmessa tunnissa ja $23$ minuutissa. $10$ minuuttia junan lähdön jälkeen
	auto lähtee Helsingistä Jyväskylään kulkien tasaista $100$ kilometrin tuntivauhtia. Jyväskylään on Helsingistä maanteitse $272$ kilometriä.
	...
	\begin{esimratk}
		...
		Voidaan nyt muotoilla yhtälö yksikköinä metri ja sekunti. Muuttujana on $t$, aika sekunteina auton lähdöstä.
...
\laatikko[Yhtälöiden muokkaaminen]{
	\begin{description}
		...
		\item[Puolittain kertominen] Yhtälön molemmat puolet voidaan kertoa nollasta poikkeavalla luvulla. Esimerkiksi kertomalla yhtälön $2x = 4$ molemmat puolet luvulla $\frac{1}{2}$ saadaan yhtälö $x = 2$.
	\end{description}
}
