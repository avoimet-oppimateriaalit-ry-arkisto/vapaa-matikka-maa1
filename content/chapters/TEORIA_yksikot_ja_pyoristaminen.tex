...
>>>>>>> 21211928495bdeb7d76dd38d3539ccfcaa1cec58
...
\begin{esimerkki}
Lääketabletin vahvuus on 25 $\upmu$g. Potilaalle on määrätty 0,1 mg vaikuttavaa ainetta. Kuinka monta tablettia määräys vastaa?

\textbf{Ratkaisu.}
Milligramman ja mikrogramman välinen \termi{suhdeluku}{suhdeluku} on 1000 (koska $10^{-3} : 10^{-6} = 1000$). Siispä 1 mg = 1000 $\upmu$g.
Näin ollen 0,1 mg = 100 $\upmu$g. Koska $4 \cdot 25 \upmu\textrm{g}$, määräys vastaa neljää tablettia. 

\textbf{Vastaus.}
Määräys vastaa neljää tablettia.
\end{esimerkki}
