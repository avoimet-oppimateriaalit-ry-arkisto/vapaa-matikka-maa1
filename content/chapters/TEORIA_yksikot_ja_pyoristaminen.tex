...
Matemaattisesti suureita käsitellään aivan kuin luku ja yksikkö olisivat kerrotut keskenään, mutta käytäntö on kirjoittaa kertolaskun sijasta luvun ja yksikön väliin väli. Luvun ja yksikön väliin tulee myös kieliopillisesti tyhjää. Tähän on muutama poikkeus: kulman suuruutta ilmaisevat asteet, minuutit ja sekunnit, joita merkataan symboleilla $\deg$, ' ja '', ja jotkin pituusyksiköt kuten tuuma, jota merkataan $'$.
...
Luvun ja yksikön kertolaskukäsityksestä seuraa, että sovelluksissa ja sievennystehtävissä yksiköillä voidaan laskea kuin luvuilla. Tutut potenssisäännöt, rationaalilukujen laskusäännöt ja kertolaskun vaihdannaisuuslaki pätevät.
