...
%Laatinut V-P Kilpi 2013-11-10
\begin{tehtava}
Eräänä päivänä eräs 3D-printteri alkoi tulostamaan uusia 3D-printtereitä, jotka taas toimivat vastaavasti. Funktio $ d(x)=4^{x} $, missä $ x $ on aika päivinä kuvaa printterien määrää ajan funktiona. Kuinka monen päivän kuluttua 3D-printtereitä on enemmän kuin ihmisiä, kun ihmisiä on noin 7 miljardia?
\begin{vastaus}
17 päivän kuluttua.
\end{vastaus}
\end{tehtava}
