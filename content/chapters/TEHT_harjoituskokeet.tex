...
\begin{description}
	...
	(a) $175$ \qquad
	(b) $384$.
	\item[8.] Kalle-Petterillä on suorakulmainen pala kartonkia, jonka pinta-ala on $21cm^2$, leveys $3cm$ ja korkeus $x$. 
	Hän haluaa taivuttaa kartongista putken. Laske putken tilavuus, kun tilavuuden kaava on $V=\pi\cdot r^2\cdot h$, jossa $V$ on tilavuus, $h$ on kartonkipalan lyhyen sivun pituus, ja $x=2\pi\cdot r$.    
\end{description}
