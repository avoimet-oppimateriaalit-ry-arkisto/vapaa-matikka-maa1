...
\begin{description}
	...
	\item[5.] Pertsa ajaa kotoansa mummolaan tunnissa, jos ajovauhti on lupsakka $60 km/h$. Nyt Pertsalla on kuitenkin kiire ja hän yrittää keretä mummolaan kahdessa kolmasosa tunnissa. Kuinka nopeasti Pertsan pitää ajaa? \\
	
	Pertsan ajaessa tätä vauhtia, tielle ryntää yhtäkkiä kirahvi. Jos jarrutusmatka on suoraan verranollinen ajonopeuden neliöön, kuinka kaukana kirahvista täytyy Pertsan ruveta jarruttamaan, että ei käy huonosti?
	\item[6.] Sievennä \\
	(a) $\frac{a^2 b^2}{a}$, $a \neq 0$ \qquad
	(b) $3(a^2+1)-2(a^2-1)$ \\
	(c) $ab(a+2a)$ \qquad
