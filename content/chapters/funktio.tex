...
% FIXME: termiparit: 1. määrittely- ja arvojoukko 2. lähtö- ja maalijoukko
...
\alakohta{Funktion lähtö- ja maalijoukot jätetään usein merkitsemättä, jos ne voidaan päätellä asiayhteydestä. Tällä kurssilla funktiot ovat yleensä reaaliluvuilta reaaliluvuille.}
