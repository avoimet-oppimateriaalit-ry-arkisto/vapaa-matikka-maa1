...
%Laatinut Emilia Välttilä 10.11.2013
  ...
  \begin{alakohdat}
    ...
    \alakohta{Mitä on $f(6)$, kun $s=1$? Minkä arvon funktio $g(x)$ tällöin saa?}
  \end{alakohdat}

  \begin{vastaus}
      \begin{alakohdat}
      \alakohta{Kun $x = 0$, $s = -\frac{3}{19}$ ja kun $x = \frac{1}{2}$, $x = \frac{1}{38}$}
      \alakohta{$f(6) = 3$ ja $g(3) = -\frac{11}{2}$}
      \end{alakohdat}
  \end{vastaus}
\end{tehtava}
...
\begin{tehtava} % Emilia Välttilä 9.11.2013
	Millä vakion $a$ arvolla funktio $g(x) = \frac{2x+1+a}{5x}$ saa arvon 5, kun $x = 3$?
\begin{vastaus}
$a=68$
\end{vastaus}
\end{tehtava}
