...
\begin{tehtava}
    ...
    Tarkista laskemalla, että toisen laskutoimituksen tulos tosiaan on sama.

    \begin{alakohdat}
        \alakohta{$3\cdot (-6)$ (vaihdantalaki)}
        \alakohta{$5\cdot (7+6)$ (vaihdantalaki)}
        \alakohta{$5\cdot (7+6)$ (osittelulaki)}
        \alakohta{$-8\cdot (-5)\cdot 2$ (liitäntälaki)}
    \end{alakohdat}
    \begin{vastaus}
	\begin{alakohdat}
	    \alakohta{$(-6)\cdot 3$}
...
\begin{tehtava}
Laske seuraavat laskut ilman laskinta soveltamalla osittelulakia ja liitäntälakia.
Kerro, mitä laskulakeja sovelsit.

    \begin{alakohdat}
        \alakohta{$350\cdot 271-272\cdot 350$}
        \alakohta{$\frac{14}{21}$}
        \alakohta{c) $\frac{12}{20}$}
    \end{alakohdat}
\begin{vastaus}
