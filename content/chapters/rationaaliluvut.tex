...
Kirjan aloittaneessa kertausosiossa puhuttiin luvuista. Lukuja on tapana luokitella seuraavasti.
    
Lukumäärää esittävät luvut 0, 1, 2, 3, ... muodostavat \termi{luonnollinen luku}{luonnollisten lukujen} joukon $\nn$.
Joukkoja merkitään listaamalla niiden alkiot aaltosuluissa, eli merkitään
\[\nn=\{0, 1, 2, 3, \ldots \} \]

Kun luonnollisten lukujen joukkoa täydennetään luonnolisten lukujen vastaluvuilla, saadaan \termi{kokonaisluku}{kokonaislukujen} joukko $\zz$.
...
\begin{tehtava}
	...
	\alakohta{Laske summa
	\[
	\frac{1}{1\cdot 2}+\frac{1}{2 \cdot 3}+ \ldots + \frac{1}{(n-1)n}
	\]
	}
	\end{alakohdat}
	\begin{vastaus}
