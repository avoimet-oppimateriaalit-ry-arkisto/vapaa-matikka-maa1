...
% PROSENTTIYKSIKKÖ
\laatikko{
    \termi{prosenttiyksikkö}{Prosenttiyksikköä} käytetään mittaamaan prosenttien välisiä eroja.
...
\begin{esimerkki}
    ...
    \begin{alakohdat}
        \alakohta{Kuinka monta prosenttia tuotteen markkinaosuus on noussut tammikuusta kesäkuuhun?}
        \alakohta{Kuinka monta prosenttiyksikköä tuotteen markkinaosuus on noussut tammikuusta kesäkuuhun?}
    \end{alakohdat}
