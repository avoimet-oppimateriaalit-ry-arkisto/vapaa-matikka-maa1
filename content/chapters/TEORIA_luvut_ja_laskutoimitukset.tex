...
\termi{rationaaliluku}{Rationaaliluvulla} tarkoitetaan lukua, joka voidaan esittää
...
Yleisesti ottaen voidaan sanoa, että kaksi '$-$'-merkkiä kumoavat toisensa.
...
%\begin{center}
\begin{luoKuva}{vali6}
	lukusuora.pohja(-4,14,3,n=2, varaa_tila = False)
	with vari("red"):
...
\hline
 $-3<x \leq 5$ & $x \in {]-3, 5]}$ & \naytaKuva{vali6} & Puoliavoin väli  \\
\hline
 $-3\leq x < 5$ & $x \in {[-3, 5[}$ & \naytaKuva{vali6} & Puoliavoin väli  \\
\hline
$-3\leq x \leq 5$ & $x \in {[-3, 5]}$ & \naytaKuva{vali6} & Suljettu väli \\
\hline
