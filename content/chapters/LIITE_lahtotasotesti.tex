Oheinen lähtötasotesti auttaa opettajaa selvittämään, mihin asioihin kurssilla kannattaa erityisesti perehtyä. Kirjoita ratkaisut välivaiheineen ja palauta testi opettajalle ensimmäisellä tunnilla arviointia varten. Testien tehtävien tekemiseen pitäisi kulua aikaa yhteensä alle varttitunti. Ei hätää, jos et osaa jotain näistä tehtävistä – jokaiseen tehtävätyyppiin paneutudutaan kyllä kurssin aikana.

%oma numerointi näille ja kirjan alkuun!
