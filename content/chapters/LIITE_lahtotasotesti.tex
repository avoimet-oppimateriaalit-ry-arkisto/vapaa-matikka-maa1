Oheinen lähtötasotesti auttaa opettajaa selvittämään, mihin asioihin kurssilla kannattaa erityisesti perehtyä. On suositeltavaa, että tehtäviin merkitään \textit{koko ratkaisu} välivaiheineen (ei vain lopullista vastausta) ja että testi palautetaan opettajalle ensimmäisellä tunnilla arviointia varten. Testien tehtävien tekemiseen pitäisi kulua aikaa alle varttitunti.
