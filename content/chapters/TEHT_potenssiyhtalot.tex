...
\end{tehtava}
\begin{tehtava}%Laati HR 10-22-2013
Tämän huomattuaan Valtteri toivoisi sijoittamansa pääoman kaksinkertaistuvan seuraavassa kymmenessä vuodessa. Kuinka suurta korkoprosenttia hänen tulee ehdottaa pankinjohtajalle?
\begin{vastaus}
$7,1\%$
\end{vastaus}
\end{tehtava}
...
Syksyllä 2012 maapallon väkiluvun arveltiin olevan noin 7 miljardia. Väkiluku oli kaksinkertaistunut arviolta 38:ssa vuodessa. Tutki laskimella, milloin seuraava miljardi saavutettaisiin, jos väestönkasvu jatkuisi vakionopeudella.
\begin{vastaus}
Noin vuonna 2020.
\end{vastaus}
\end{tehtava}
