...
%Aleksi värkkää 09-11-2013
\begin{tehtava} Laske. 
a) $ \frac{\sqrt{8}}{\sqrt{2}}$  \quad b)   $ \frac{\sqrt{64}\}}{\sqrt[3]{8}}$   \quad c)  $ \frac{\sqrt{3} \cdot \sqrt{6}}{\sqrt{2}}$ \quad d) $ \frac {\sqrt[3]{2}}{\sqrt[3]{16}} \cdot \sqrt[3]{4}$ 
\begin{vastaus}
a) 2 \quad b) 8 \quad c) 3 \quad d) 2
\end{vastaus}
\end{tehtava}

%Aleksi värkkää 09-11-2013
\begin{tehtava} Laske. 
a) $ \frac{{\sqrt{15}}{\sqrt{7}}} \cdot  \frac{\sqrt{27}}{\sqrt{35}}$  \quad b)  $ \frac{\sqrt{64}-\sqrt{9}}{\sqrt{5}}$   \quad c)  $ \frac{\sqrt{15}}{\sqrt{7}} \cdot \frac{\sqrt{35}}{\sqrt{3}}$ \quad 
\begin{vastaus}
a) 9/7 \quad b) $sqrt{5}$ \quad c) 1 \quad
\end{vastaus}
\end{tehtava}

%Aleksi värkkää 09-11-2013
\begin{tehtava} Etsi positiivinen rationaaliluku a, jolla
a) $\sqrt{a} \sqrt{2}\ = 2$  \quad b)   $ \frac {\sqrt{a}} {\sqrt{3}} =9 $   \quad c)  $ \frac {\sqrt[a]{27}}{\sqrt{a}}=1 $ \quad 
\begin{vastaus}
a) a=8\quad b) a=28 \quad c) a=3 \quad
\end{vastaus}
\end{tehtava}
...
a) $\frac {sqrt{a}}{{sqrt{b}} $ on jokin luonnollinen luku  \quad 
b) $\sqrt[b]{a}=2 $   \quad 
c) $\sqrt[a]{27}\sqrt[b]{3}$ on jokin luonnollinen luku
