...
Laskusäännöt pätevät kaikille positiivisille reaaliluvuille x ja y, kun m ja n ovat luonnollisia lukuja sekä suurempia kuin nolla. 
$\sqrt[m]{x}\cdot{\sqrt[m]{y}}=\sqrt[m]{xy}$ \quad 
...
a) $\sqrt{3}\cdot{\sqrt{48}}=\sqrt{{3}\cdot{48}}=\sqrt{144}=12$ 
