...
Mitä tahansa lukua tai kirjoitettua laskutoimitusta (kuten kuten $9$ tai $\frac{x}{3}-9$) kutsutaan \termi{Lauseke}{lausekkeeksi}. \termi{Termi}{Termi} puolestaan on yksi yhteenlaskettava osa lausekkeesta. Termi voi olla luku, vakio, muuttujista tai mikä tahansa näiden keskenään muodostama tulo kuten $-4\sqrt{2}ax^2$.
