...
Niinpä matematiikassa voi luvun $42$ paikalle kirjoittaa merkinnän $(50-29)\cdot 2$, sillä se tarkoittaa samaa lukua.

Kun lauseke muodostuu yhteenlaskusta, käytetään nimitystä \termi{termi}{Termi} tarkoittamaan yhtä yhteenlaskettavaa
osa lausekkeesta. Termissä voi olla yhdistelmä luvuista, vakioista
...
\begin{esimerkki} 
 ...
 \begin{alakohdat}
   \alakohta{sievennetään $2+c-c$, jossa c on mikä tahansa kokonaisluku.}
\end{alakohdat}
\end{esimerkki}
