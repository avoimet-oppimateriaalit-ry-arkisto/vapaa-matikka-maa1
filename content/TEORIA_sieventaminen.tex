Tässä luvussa tutustumme lisää laskutoimitusten terminologiaan ja siihen, miten laskutoimituksia ja muuta työskentelyä voidaan usein helpottaa kirjoittamalla lasku eri tavalla.

Mitä tahansa lukua tai kirjoitettua laskutoimitusta kutsutaan \termi{lauseke}{lausekkeeksi}. Lausekkeen \termi{arvo}{arvoksi} kutsutaan sitä lukua, joka saadaan, kun lausekkeen laskutoimitukset lasketaan.

\begin{esimerkki}
\alakohdat{
§ Lausekkeen $2$ arvo on $2$.
§ Lausekkeen $5-3$ arvo on $2$.
§ Lausekkeen $\frac{x}{3}-9$ arvo ei ole vakio, vaan sen arvo riippuu muuttujasta $x$.
}
\end{esimerkki}
...
%§ Koska luku $12$ voidaan kirjoittaa tekijöidensä avulla kertolaskuna $3\cdot 4$, voidaan jakolaskussa $\frac{12}{4}$ tehdä sijoitus $12=3 \cdot 4$ ja kirjoittaa se uudelleen muodossa $\frac{3\cdot 4}{4}$. Tämä 
%yhtälöiden yksinkertaistaminen, supistettavuuden osoittaminen
%}
\end{esimerkki}
