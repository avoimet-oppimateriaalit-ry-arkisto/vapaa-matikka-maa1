Mitä tahansa lukua tai kirjoitettua laskutoimitusta (kuten $9$ tai $\frac{x}{3}-9$) kutsutaan \termi{lauseke}{lausekkeeksi}.
...
Kun lauseke muodostuu yhteenlaskusta, käytetään nimitystä \termi{termi}{termi} tarkoittamaan yhtä yhteenlaskettavaa
...
Matemaattisia ongelmia ratkaistaessa kannattaa usein etsiä vaihtoehtoisia tapoja jonkin laskutoimituksen,
lausekkeen tai luvun ilmaisemiseksi. Tällöin usein korvataan esimerkiksi jokin laskutoimitus toisella
laskutoimituksella, josta tulee sama tulos. Näin lauseke saadaan sellaiseen muotoon, jonka avulla ratkaisussa
päästään eteenpäin. Kun merkitsemme monimutkaisen lausekkeen lyhyemmin, sitä kutsutaan
\termi{sieventäminen}{sieventämiseksi}. Sieventäminen on ikään kuin sotkuisen kaavan siistimistä selkeämmäksi.
Tähän lukuun on koottu sääntöjä, joiden avulla lauseketta voi muutaa niin, että sen arvo ei muutu.

Seuraavassa on esitelty tärkeimpiä sääntöjä, joita voidaan käyttää lausekkeiden sieventämisessä:
...
\laatikko{
\begin{alakohdat}
\alakohta{$a\cdot \frac1a=0$}
\alakohta{$\frac1a\cdot a=0$}
\alakohta{$a\cdot b:b=a$}
\alakohta{$a:b\cdot b=a$}
\end{alakohdat}
}

Näiden sääntöjen avulla voidaan poistaa ylimääräisiä termejä ja tulontekijöitä lausekkeesta.

\begin{esimerkki}

Sievennetään $2+c-c$, jossa c on mikä tahansa kokonaisluku.\\
Ratkaisu: koska yhteenlasku ja vähennyslasku ovat toistensa käänteistoimituksia, tämän lausekkeen
arvo on $2$ riippumatta siitä, mikä on $c$:n arvo.
\end{esimerkki}
