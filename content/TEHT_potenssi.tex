...
Sievennä.
	\alakohdat{
	§ $\frac{2x^5+3x^3}{x^2}$
	§ $\frac{6x^2+8y}{2x^2}$ %ei potenssitehtävä -> rationaalilukuihin?
	§ $\frac{3x-2x^2y^3}{xy}$ %ei potenssitehtävä -> rationaalilukuihin?
...
\begin{tehtava}
%Tehtävän laatinut Johanna Rämö 9.11.2013. %yksikkölukuun?
...
Muotoa $2^n-1$ olevia alkulukuja, missä todistettavasti välttämättäkin myös $n$ on alkuluku, kutsutaan \termi{Mersennen alkuluku}{Mersennen alkuluvuiksi}. Vastsa 1700-luvulla sveitsiläinen Euler todisti, että kaikki parilliset täydelliset luvut voidaan esittää kyseisessä muodossa.
\alakohdat{
...
\paragraph*{Lisää tehtäviä}
    ...
    \begin{tehtava} %siirretään yksikkötehtäviin?
...
\begin{tehtava}
$\star$ Kompleksilukujen niin sanottu \termi{imaginääriyksikkö}{imaginääriyksikkö} $i$ määritellään seuraavalla (kaikista reaaliluvuista poikkeavalla) ominaisuudella:
