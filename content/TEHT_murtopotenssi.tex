...
\begin{tehtava}
	...
	\begin{vastaus}
		\alakohdat{
			...
			§ Arvot vakiintuvat, kun $0,00659 \ldots \leq x \leq 1,444667\ldots$. Tämän voi esittää muodossa $\frac{1}{e^e} \leq x \leq \sqrt[e]{e}$, missä $e$ on vakio nimeltään Neperin luku. Desimaalilukuna $e = 2,718281828459\ldots$
		}
\end{vastaus}
\end{tehtava}
\begin{tehtava}
