...
\alakohdat{
§ Lasketaan kanipopulaation kokoa peräkkäisinä vuosina. Merkitään $a=\text{alkuperäinen kaniinien määrä}=24$ ja 
...
§ Taulukoidaan kaniinipopulaation arvoja. Huomaamalla, että $f(t)$:n lausekkeesta voidaan ottaa yhteiseksi tekijäksi $a$, saadaan lauseketta
...
§ Halutaan tietää, millä $t$:n arvolla kaniinipopulaation kokoa kuvaava funktio saa arvokseen vähintään miljoonan, eli
...
\textbf{Vastaus.}
\alakohdat{
	§ Vuoden kuluttua noin 160 yksilöä, kahden vuoden kuluttua noin 1010 yksilöä.
