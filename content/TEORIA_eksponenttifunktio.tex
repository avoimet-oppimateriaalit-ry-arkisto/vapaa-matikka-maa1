...
\begin{alakohdat}
	...
	\alakohta{Monenko vuoden kuluttua Marssin kaniinipopulaatio on ylittänyt miljoonan yksilön rajan?}
\end{alakohdat}
...
2 &   $\left(\frac{13}{2}a\right)\cdot\frac{13}{2}= \frac{13^2}{2^2}a$  & $f(2)=24\cdot\frac{13^2}{2^2}= 1014$\\ \hline 
...
\textbf{Vastaus.}
\begin{alakohdat}
	\alakohta{Vuoden kuluttua noin 160 yksilöä, kahden vuoden kuluttua noin 1010 yksilöä.}
	\alakohta{$ 24\cdot(\frac{13}{2})^n $ yksilöä.}
	\alakohta{Kuuden vuoden kuluttua.}
\end{alakohdat}
