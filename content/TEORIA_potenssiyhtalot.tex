...
Eksponentin $n$ ollessa kokonaisluku sen arvoa kutsutaan potenssiyhtälön \termi{aste (potenssiyhtälö)}{asteeksi}. Esimerkiksi yhtälön $x^2=0$ aste on $2$.
	...
	\begin{alakohdat}
		...
		\alakohta{Yhtälö $2x^{4}-7=3$ on potenssiyhtälö, sillä se voidaan muokata muotoon $x^n = a$,
			\begin{eqnarray*}
				...
				x^{4} &=& 5.
			\end{eqnarray*}}
		\alakohta{Yhtälö $x^{\frac{3}{2}}=42$ ei ole potenssiyhtälö, sillä eksponentti $\frac{3}{2}$ ei ole kokonaisluku. Yhtälö voidaan kuitenkin kirjoittaa uuden tuntemattoman $z=x^{\frac{1}{2}}=\sqrt{x}$ avulla: tällöin saadaan potenssiyhtälö $x^{\frac{3}{2}} = x^{\frac{1}{2} \cdot 3} = z^3 = 42$.)}
...
\laatikko{Mikäli potenssiyhtälön asteluku $a$ on parillinen, yhtälö on ratkaistavissa jos ja vain jos $\frac{b}{a} \geq 0 $. Parillisella potenssifunktiolla voi olla yksi, kaksi tai ei yhtään ratkaisua.}
