...
\begin{tehtava}
	Bändi laskee CD-levynsä hintaa $20\,\%$. Pian heitä alkaa kuitenkin kaduttaa. Monellako prosentilla muutettua hintaa olisi korotettava, jotta hinta olisi ennallaan? %muutetaan CD modernimmaksi...
		\begin{vastaus}
		 $25\,\%$
		\end{vastaus}
\end{tehtava}
