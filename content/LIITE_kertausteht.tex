...
\begin{tehtava}
	...
	\begin{alakohdat}
		...
		\alakohta{$\frac{de}{a}:\frac{db}{a}-\frac{e^2b^2}{be^2} $}
	\end{alakohdat}
...
\begin{vastaus}
	\begin{alakohdat}
		\alakohta{$\frac{3\,651}{50}$}
		\alakohta{$\frac{171\,217}{9\,999}$}
		\alakohta{$\frac{64}{75}$}
		\alakohta{$-\frac{3\,526}{495}$}
	\end{alakohdat}
\end{vastaus}
\end{tehtava}
...
\begin{tehtava}
	...
	\begin{alakohdat}
		...
		\alakohta{$f(0)$}
		\alakohta{$g(-4)$}
		\alakohta{$f\left(\frac{1}{2}\right)\cdot g\left(\frac{1}{2}\right)$}
		\alakohta{$f\left(g(2)\right)$}	
	\end{alakohdat}
	
\begin{vastaus}
	\begin{alakohdat}
		\alakohta{$-\frac{1}{2}$}
		\alakohta{Ei määritelty, koska nollalla ei voi jakaa}
		\alakohta{$8$}
		\alakohta{$-4$}
		\alakohta{$-\frac{1}{2}$}
	\end{alakohdat}
