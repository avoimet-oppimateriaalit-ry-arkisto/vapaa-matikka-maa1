...
\begin{tehtava}
Lukuja, jotka ovat itsestään poikkeavien tekjöidensä summia, sanotaan \termi{täydellinen luku}{täydellisiksi luvuiksi}. Esimerkiksi $6$ on täydellinen luku, sillä $6=1+2+3$. Tällä hetkellä ei tiedetä, onko täydellisiä lukuja äärettömän montaa. Myöskään ei tiedetä, onko parittomia täydellisiä lukuja olemassa.
%\alakohdat{
%§
