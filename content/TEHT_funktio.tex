...
\begin{tehtava}
Määritä kuvaajasta katsomalla funktion \(f\) nollakohdat suunnilleen. Saako funktio \(f\) sekä negatiivisia ja positiivisia arvoja?
\begin{kuva}
    kuvaaja.pohja(-3, 3, -4, 2)
    kuvaaja.piirra("2*x**4-5*x**2+1", nimi = "$f$")
\end{kuva}
\begin{vastaus}
Funktion \(f\) nollakohdat ovat $x$-koordinaatistossa suunnilleen $-1.5$, $-0.5$, $0.5$ ja $1.5$. Funktio saa sekä positiivisia että negatiivisia arvoja.
\end{vastaus}
\end{tehtava}
