...
§ Newtonin painovoimalain mukaan kahden massan välisen vuorovaikutuksen suuruus on verrannollinen käänteisesti niiden etäisyyden neliöön: $F=\gamma \frac{m_1m_2}{r^2}$, missä $\gamma$ on universaali painovoimavakio ja $r$ on massojen välinen etäisyys. Siis $F \propto m_1, F \propto m_2$ ja $F \propto r^{-2}$.
}
\end{esimerkki}
