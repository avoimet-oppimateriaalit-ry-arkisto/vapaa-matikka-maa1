...
Kappaleessa \ref{neliojuuri} sivuttiin itseisarvon määritelmää. Itseisarvofunktio $\lvert \rvert$ voidaan määritellä seuraavasti. \\ 
$$
\lvert \rvert\colon \mathbb{R} \to \mathbb{R_+}, \\ \lvert x \rvert = \begin{cases}
                 x & \text{jos } x \geq 0 \\
                 -x & \text{jos } x < 0
