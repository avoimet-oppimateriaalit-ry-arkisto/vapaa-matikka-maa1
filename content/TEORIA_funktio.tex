...
\laatikko{
  \termi{funktio}{Funktio} eli \termi{kuvaus}{kuvaus} joukosta $A$ joukkoon $B$ liittää jokaiseen joukon $A$ alkioon täsmälleen yhden joukon $B$ alkion. Funktion $f$ alkioon $x$ liittämää arvoa merkitään $f(x)$. 
...
Funkition määrittelyjoukko on niiden arvojen joukko, joille funktion arvo on olemassa. Jos määrittelyjoukkoa ei ole mainittu erikseen, määrittelyjoukolla tarkoitetaan tavallisesti sitä reaalilukujen osajoukkoa joille funktion arvo voidaan laskea. %Jouni Kärkkäinen 92.2.2014
