...
Lisäksi parillisilla $m$:n arvoilla $\sqrt[m]{x^m}=|x|$, missä merkintä $|x|$ tarkoittaa luvun $x$ itseisarvoa. Itseisarvo ilmaisee luvun etäisyyttä nollasta lukusuoralla, joten se on aina positiivinen, esim. $|4| = 4$ ja $|-5| = 5$. Itseisarvo määritellään tarkemmin luvussa 3.1.
}
