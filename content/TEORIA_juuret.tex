...
%Neliöjuurta ei tällä kurssilla määritellä negatiivisille luvuille, koska jokaisen reaaliluvun neliö on positiivinen tai nolla. (Toisin sanoen ei ole esimerkiksi mitään sellaista reaalilukua $a$, että $a^2 = -2$.) Käytännössä lukujen neliöjuuria lasketaan usein laskimella.

%Neliöjuurta _ei voi_ määritellä negatiivisille luvuille! Myöskään kompleksilukujen yhteydessä neliöjuurta ei voi ristiriidattomasti määritellä negatiivisille luvuille. Huolimattomasti kirjoitetuissa oppikirjoissa virhe on tavallinen. Kylläkin i² = -1, mutta tästä ei seuraa sqrt(-1) = i. Tämä johtaisi helposti nähtävään ristiriitaan. -Jouni
...
<<<<<<< HEAD
Lisäksi parillisilla $m$:n arvoilla $\sqrt[m]{x^m}=|x|$, missä merkintä |x| tarkoittaa luvun x \termi{itseisarvo}{itseisarvoa}, jolle pätee $|x| = \left\{ \begin{array}{ll} x & \mbox{jos } x \geq 0 \\ -x & \mbox{jos } x < 0 \end{array} \right.$
=======
Lisäksi parillisilla $m$:n arvoilla $\sqrt[m]{x^m}=|x|$, missä merkintä $|x|$ tarkoittaa luvun $x$ itseisarvoa. Itseisarvo ilmaisee luvun etäisyyttä nollasta lukusuoralla, esim. $|4|=4$ ja $|-5|=5.$ Itseisarvo määritellään tarkemmin luvussa .
%Tässä on itseisarvon formaali määritelmä, sen voi poistaa jos sitä ei tarvita: $|x| = \left\{ \begin{array}{ll} x, & \mbox{jos } x \geq 0 \\ -x, & \mbox{jos } x < 0 \end{array} \right.$
>>>>>>> 5fdbc463d942f040a3ff8a6cd4f8772a11a09c1a
