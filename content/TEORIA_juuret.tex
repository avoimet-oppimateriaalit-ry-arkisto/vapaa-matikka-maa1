...
\begin{esimerkki}
Sievennä juurilausekkeet $\sqrt{8}$ ja $\sqrt{\frac{9}{16}}$. %luettelomerkintä

	\begin{esimratk}
	\alakohdat{
§ Koska $8$ voidaan kirjoittaa tulona $2\cdot4$, on $\sqrt{8}=\sqrt{2\cdot 4}$. Juurten tulosäännön nojalla tämä voidaan kirjoittaa	 kahden neliöjuuren tulona $\sqrt{2}\sqrt{4}$, joka sievenee muotoon $2\sqrt{2}$. Sievennystapana on, että juuren sisälle jätetään mahdollisimman yksinkertainen (itseisarvoltana pieni) luku.
