...
§ Tiheys (tunnus $\rho$, kreikkalainen pieni \textit{roo}) on johdannaissuure, joka määritellään massan ja tilavuuden osamääränä: $\text{tiheys}=\frac{\text{massa}}{\text{tilavuus}}$. Vastaavasti tiheyden yksiköt saadaan samalla jakolaskulla massan ja tilavuuden yksiköistä: jos kappaleen tilavuus on mitattu kuutiometreissä ja massa kilogrammoina, voidaan kappaleen tiheys esittää yksiköissä $\frac{\text{kg}}{\text{m}^3}$. Erityisesti kannattaa musitaa, että veden tiheys on noin yksi kilogramma per litra.
}
}
