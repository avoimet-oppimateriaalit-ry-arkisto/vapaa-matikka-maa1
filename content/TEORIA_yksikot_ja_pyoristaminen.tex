...
§ Pinta-ala (tunnus usein $A$, engl. area) saadaan kertomalla pituus toisella pituudella. Vastaavasti pinta-alan yksiköt saadaan pituuden yksiköistä. Jos esimerkiksi pituutta on mitattu metreissä, niin vastaava pinta-alan yksikkö on $m\cdot m=m^2$ eli neliömetri.

§ Tilavuus (tunnus usein $V$, engl. volume) on edelleen johdettavissa kolmen pituuden tulona. Jos pituutta on mitattu metreissä, niin vastaava tilavuuden yksikkö on $m\cdot m \cdot m=m^3$ eli kuutiometri.
