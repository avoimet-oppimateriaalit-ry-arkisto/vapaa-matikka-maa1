...
\begin{tehtava} (K2014/ 1b ja 1c) 
	\begin{alakohdat}
		\alakohta{Laske lausekkeen {\Large$\frac{a^2-b^2}{a-b}$} arvo, kun $a=1$ ja $b=\frac{1}{2}$.}
		\alakohta{Ratkaise yhtälö {\Large$\frac{x}{3}=\frac{x-1}{4}$}.}
	\end{alakohdat}
    \begin{vastaus}
	\begin{alakohdat}
		 \alakohta{$\frac{3}{2}$}
...
\begin{tehtava}(K2014/ 2a ja 2b)
	 \begin{alakohdat}
		 \alakohta{Missä pisteessä suora $x-5y=4$ leikkaa $y$-akselin?}
		 \alakohta{Ratkaise yhtälö $4x^3=48$. Anna tarkka arvo ja kolmidesimaalinen likiarvo.}
	 \end{alakohdat}
    \begin{vastaus}
	 \begin{alakohdat}
		  \alakohta{pisteessä $(0\quad,\quad-\frac{4}{5})$}
		  \alakohta{$x=\sqrt[3]{12}\approx2,289$}
	 \end{alakohdat}
    \end{vastaus}	
\end{tehtava}
%lisännyt jaakko viertiö 22.3.2014

\begin{tehtava} (K2014/5) Boolimaljassa on $4,0$ litraa sekoitusta, jonka tilavuudesta $70\,\%$ on 
kuohuviiniä ja $30\,\%$ mansikkamehua. Kuinka paljon siihen täytyy lisätä kuohuviiniä, jotta mehun 
osuus on $20\,\%$?
    \begin{vastaus}
...
\begin{tehtava} (K2014/6) Kiinalainen arvoitus $5\,000$ vuoden takaa: Häkissä on fasaaneja ja kaniineja. 
Oletetaan, että yhdellä fasaanilla on yksi pää ja kaksi jalkaa, ja yhdellä kaniinilla yksi pää ja neljä 
jalkaa. Niillä on yhteensä $35$ päätä ja $94$ jalkaa. Kuinka monta fasaania ja kuinka monta kaniinia 
häkissä on?
	\begin{vastaus}
...
ei otettu huomioon mahdollisia kuntaliitoksia.
	\begin{alakohdat}
		\alakohta{Ennusteen mukaan asukasluku $y$ toteuttaa yhtälön \[y=a(x-2014)+6,\] kun $x$
		on vuosiluku. Määritä vakioiden $a$ ja $b$ tarkat arvot käyttämällä yllä mainittuja tietoja.}
		\alakohta{Kuinka paljon asukasluku kasvaa ennusteen mukaan aikavälillä $2014--2030$? Anna vastaus 
		$1\,000$ asukkaan tarkkuudella.}
		\alakohta{Piirrä asukasluvun $y$ kuvaaja välillä $2014 \leq x \leq 2030$.}
	\end{alakohdat}
    \begin{vastaus}
	\begin{alakohdat}
		\alakohta{$a=5\,619,25 \text{ja} b=607\,417$}
		\alakohta{$90\,000$}
		\alakohta{Kuvaaja?}
	\end{alakohdat}
    \end{vastaus}
\end{tehtava}
%lisännyt jaakko viertiö 22.3.2014
%tarvitaanko vastauksiin c-kohtaan kuvaaja, vai jätetäänkö se vastauksista? jaakko
...
\begin{tehtava}(S2007/4)   Tuotteen hintaa korotettiin $p$ prosenttia, jolloin menekki väheni.
...
\begin{tehtava}(K2003/1)   Sievennä lausekkeet
        \begin{alakohdat}
            \alakohta{$ \sqrt{3\frac{3}{4}} \big/ \sqrt{1\frac{2}{3}} $}
            \alakohta{$ \left( \frac{x}{y} + \frac{y}{x} - 2 \right) \big/ \left( \frac{x}{y} - \frac{y}{x} \right) $.}
        \end{alakohdat}
\end{tehtava}
...
\begin{tehtava}(S2000/1)   Sievennä seuraavat lausekkeet:
                        \begin{alakohdat}
                            \alakohta{$ \left( x^{n - 1} \right)^{n - 1} \cdot \left( x^{n} \right)^{2 - n} $}
                            \alakohta{$ \sqrt[3]{a} \; ( \sqrt[3]{a^2} - \sqrt[3]{a^5}) $}
                        \end{alakohdat}
\end{tehtava}
