...
\begin{esimerkki}
Vetymolekyylissä H$_2$ ytimien välinen etäisyys on noin $0,000000000074$\,m eli $7,4\cdot10^{11}$\,m.  %samanlainen selitys, mistäaletaan laskemaan numeroiden määrää
\end{esimerkki}
...
Tietokoneiden rakenteen kaksikantaisuuden (ks. liite lukujärjestelmistä) johdosta tavujen kerrannaisyksiköllä tarkoitetaan kymmenen potenssien sijaan usein lähimpiä kahden potensseja: kilotavu (kt) ei tarkoita tasan $1\,000$ tavua vaan $1\,024$ tavua ($2^{10}$), yksi megatavu (Mt) on $1024$\,kt (eli $1\,048\,576 = 2^{20}$ tavua), yksi gigatavu $1\,024$\,Mt ja niin edelleen.

SI-järjestelmä ei tue tätä, vaan sen mukaan kt on tasan $1000$\,t ja niin edelleen. Binäärikerrannaisyksiköt sisältyvät IEC-standardiin (\textit{International Electrotehcnical Commission} ja merkitään KiB, MiB nje. mutta eivät ole levinneet laajalle. Kuluttajan hämmennykseksi usein esimerkiksi keskusmuistien koosta puhuttaessa käytetään binäärikerrannaisyksikköjä mutta kiintolevyjen koosta puhuttaessa kymmenen potensseja.
...
§ Eksponentiksi halutaan $-9$, joten  $9,0 \cdot 10^{-12}$  $0,009\,\textrm{nl}$!
}
\end{esimratk}
\end{esimerkki}
