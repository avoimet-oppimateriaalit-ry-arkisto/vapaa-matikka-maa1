...
\begin{esimerkki}
\alakohdat{
§ Aika on suure, jota voidaan mitata käyttämällä yksikkönä esimerkiksi sekunteja tai vuosia. Sovelluksissa suuresta saatetaan joskus käyttää myös nimeä kesto tai jopa pituus: ''Meneekö vielä pitkään?''
...
&=(1,2+2,6)\cdot \text{g} && \text{osittelulaki (ja vaihdantalaki, koska osittelulaki yksinään toimii ''vasemmalta puolelta'')} \\
...
§ Todellinen astronominen vuorokausi on aika, joka Maalta kestää pyörähtää kerran oman akselinsa ympäri, on $23$ tuntia, $56$ minuuttia ja $4,1$ sekuntia. Laskutehtävissä käytetään kuitenkin tavallisesti yksinkertaistettua määritelmää, jonka mukaan vuorokausi on tasan $24$ tuntia. Vuorokausiyksikön lyhenne yleiskielessä vrk ja SI-järjestelmässä d, engl. \textit{day}.
...
%\begin{esimerkki}
%\alakohdat{
%§ Ajanottoon tarkoitettu sekuntikello saattaa näyttää tuloksen muodossa $34.56.78$, eli $34$ minuuttia, $56$ sekuntia ja $78$ sadasosasekuntia.
%§ 
%}
%\end{esimerkki}
...
Koska yksiköitä voidaan kohdella laskuteknisesti kuin lukuja, niin niitä voi kertoa ja jakaa keskenään. Tutut potenssisäännöt, rationaalilukujen murtolukuesityksen laskusäännöt sekä kertolaskun vaihdanta- ja liitäntälaki pätevät. Kerrannaisyksiköiden etuliitteet voi aina muuttaa tarvittaessa kymmenpotenssimuotoon tai murtolausekkeiksi.
