...
\begin{tehtava}
Pullareseptin (http://kotiliesi.fi/ruoka/reseptit/pullataikina) mukaan taikinaan tarvitaan $5$\,dl maitoa, $2$\,dl sokeria ja $1,5$\,l vehnäjauhoja. Tällöin saadaan $40$ pikkupullaa.
	\alakohdat{
		§ Jesse haluaa leipoa $16$\,pullaa. Kuinka paljon hän tarvitsee maitoa, sokeria ja vehnäjauhoja?
		§ Jos Jesse on käytössä $3$\,dl maitoa, kuinka monta pikkupullaa hän voi enintään tehdä?
		%§Jos halutaan vähintään pullaa, muttei välitetä sen tarkemmin, mitä inaesta tarvitaan eniten(vähiten ja minkä verran vähintään?
	} 
	\begin{vastaus}
		\alakohdat{
