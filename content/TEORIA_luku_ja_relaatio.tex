...
§ Kaikille (ainakin lukiotasollla käsiteltäville) luvuille $x$ ja $y$ pätee $x+y=y+x$,eli yhteenlaskun järejstyksellä ei ole väliä. Tämä on paljon helpompaa kuin luetella (äärettömän monta tapausta), esimerkiksi $2+3=3+2$, $2+4=4+2$, $3+4=4+3$, $2+5=5+2$ ja niin edelleen.
}
\end{esimerkki}
