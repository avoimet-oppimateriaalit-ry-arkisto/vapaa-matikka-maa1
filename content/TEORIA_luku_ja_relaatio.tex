...
§ Jos näet yhdysvaltalaisessa yhteydessä ilmaisun $1,000.50$ dollaria, tämä tarkoittaa tuhatta dollaria ja $50$ senttiä. Suomenkielisessä tekstissä sama luku kirjoitettaisiin $1\,000,50$ dollaria. Tekniikan alan teksteissä suositellaan myös amerikanenglannissa käytettäväksi tuhaterottimena ohutta väliä pilkun tai pisteen sijaan.
}
\end{esimerkki}

Matematiikan merkintätavat eivät yleensä ole mitään niin sanottua luonnollista kieltä kuten suomi tai tanska, vaan asiat pyritään merkitsemään tiivisti ja mahdollisimman yleisin merkinnöin niin, että samoja merkintöjä ymmärtäisi joku muukin kuin samaa äidinkieltä puhuva. Matematiikan kehitys on sitä myöten tuonut mukanaan suuren määrän erilaisia symboleita ja historian varrella muodostuneita käytäntöjä.
...
Yhteenlasku on esimerkki relaatiosta, joka yhdistää kaksi lukua johonkin kolmanteen lukuun, jota kutsutaan yhteenlaskun summaksi. Kyseinen relaatio ei siis vain liitä kahta lukua toisiinsa -- tällaisia relaatioita kutsutaan \termi{laskutoimitus}{laskutoimituksiksi}. Vielä yleisemmin puhutaan \termi{operaatio}{operaatioista}, kun relaation kohteena eivät välttämättä ole luvut vaan jotkin abstraktimmat oliot.