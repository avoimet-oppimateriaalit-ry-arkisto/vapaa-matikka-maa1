...
\alakohdat{§ $-5$ § $\frac82$ § $\pi$ § $0,888\ldots$ § $2,995$ § $\sqrt{2}$ }

\begin{vastaus}
\alakohdat{§ $\zz$, $\qq$ ja $\rr$ § $\nn$, $\zz$, $\qq$ ja $\rr$ § vain $\rr$ §$\qq$ ja $\rr$ § $\qq$ ja $\rr$ § vain $\rr$}
\end{vastaus}
\end{tehtava}
...
\begin{vastaus}
\alakohdat{§ $-2$ § $0$ § Sellaista ei ole. Jos nimittäin $a > -3$, niin keskiarvo
